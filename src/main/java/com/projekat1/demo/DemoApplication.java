...
public class DemoApplication {
    ...
    public static void main(String[] args) {
        ...
        PostpaidKorisnik pk=new PostpaidKorisnik("marko","Manic","mb","223",ip,new TarifniPaket(12,200,false,200,50),0);
        ...
        ppk = new PostpaidKorisnik("marko","manic","221","223",ip,new TarifniPaket(10,1000,false,100,5),0);
        ...
        System.out.println(pk.napraviListing());
    }
